    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('manual', 'Manual Payment'), ('crypto', 'Crypto Payment'), ('deduction', 'Tool Download Deduction')], max_length=30)),
                ...
                ('proof', models.FileField(blank=True, null=True, upload_to='wallet_proofs/')),
